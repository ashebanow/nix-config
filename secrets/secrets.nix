let
  ...
  nixos-wsl_pub = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIAXJMQIKJGYu16HPZNjlFlQWLjaVIPdDtCHznIM7j88p root@NixOS-WSL";
  yuzu_pub = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIDXAe0NETgTw3cQYz2/pnB6RsB8JxUTRpdYdr1wTnaeV root@nixos";
  systems = [calamansi_pub limon_pub miraclemax_pub nixos-wsl_pub yuzu_pub];
in {
