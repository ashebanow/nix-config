let
  ...
  liquid-nixos_pub = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIOAv0PE/4Vy3g6ko6khdmX+s7Gg7xggA5FHHkgw+iEjc root@liquid-nixos";
  ...
  systems = [calamansi_pub limon_pub liquid-nixos_pub miraclemax_pub yuzu_pub];
in {
